...
DATASET_DIR = os.path.join(RAW_DIR,"ENA","sf_ptms")
...
# load metadata
metadata = pd.read_table(os.path.join(SUPPORT_DIR,'ENA_filereport-sf_ptms.tsv'))
...
rule download_metadata:
    ...
    shell:
        """
        bash scripts/ENA-download_sf_ptms_metadata.sh > {output}
