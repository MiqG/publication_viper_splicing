...
DATASET_DIR = os.path.join(RAW_DIR,"ENA","sf_drugs")
...
# load metadata
metadata = pd.read_table(os.path.join(SUPPORT_DIR,'ENA_filereport-sf_drugs.tsv'))
...
rule download_metadata:
    ...
    shell:
        """
        bash scripts/ENA-download_sf_drugs_metadata.sh > {output}
