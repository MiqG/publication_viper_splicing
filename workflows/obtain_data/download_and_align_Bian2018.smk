...
ARTICLE_DIR = os.path.join(ARTICLES_DIR,'Bian2018')
...
# load metadata
metadata = pd.read_table(os.path.join(SUPPORT_DIR,'ENA_filereport-PRJNA394872_PRJNA434108-Bian2018.tsv'))
