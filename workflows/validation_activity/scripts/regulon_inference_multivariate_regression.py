...
##### FUNCTIONS #####
def fit_single(x_genexpr, y_splicing, thresh_fdr):
    X = x_genexpr
    y = y_splicing
...
def fit_all(regulators, targets, thresh_fdr, n_jobs, batch_size=10000):
...
def main():
    ...
    # fit models
    results = fit_all(regulators, targets, thresh_fdr, n_jobs)
